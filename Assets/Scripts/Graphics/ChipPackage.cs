...
public class ChipPackage : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (builtinChip)
        {
            ...
            SetColor(builtinChip.packageColor);
        }
    }
    ...
    public void PackageCustomChip(ChipEditor chipEditor)
    {
        ...
        nameText.color = chipEditor.chipNameColor;
        SetColor(chipEditor.chipColor);
    ...
    {
        container.GetComponent<MeshRenderer>().material.color = color;
    }
}
