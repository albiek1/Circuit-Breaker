...
public static class MathUtility
{
    ...
    public static Vector2 PointOfLineIntersection(Vector2 a1, Vector2 a2, Vector2 a3, Vector2 a4)
    {
    ...
    public static bool RaySphere(Vector3 center, float radius, Vector3 rayOrigin, Vector3 rayDir, out Vector3 intersctionPoint)
    {
        Vector3 offset = rayOrigin - center;
        ...
        if(discriminant >= 0)
        {
            ...
            if(t >= 0)
            {
                intersctionPoint = rayOrigin + rayDir * t;
                return true;
            }
        }
        intersctionPoint = Vector3.zero;
        return false;
    }
